...
def scrap(anio):
    ...
    if anio > 2012:
        #scrapper
        url = "https://www.sii.cl/valores_y_fechas/uf/uf{}.htm".format(anio)
        driver.get(url)
        ...
        url = "https://www.sii.cl/pagina/valores/uf/uf{}.htm".format(anio)
        driver.get(url)
    ...
    for d in range(len(tabla_raw)):
        ...
        for m in range(len(fila)):
            ...
            try:
                ...
                row = {"id_serie":5,"fecha":fecha,"valor":valor,"updated":updated}
                dataset.append(row)
